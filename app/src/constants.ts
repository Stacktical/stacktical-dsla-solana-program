...
export const SLA_PROTOCOL_DEPLOYER = {
  publicKey: new PublicKey([
    131, 218, 37, 152, 136, 89, 103, 247, 100, 150, 178, 36, 20, 126, 167, 1, 62, 222, 89, 85, 140, 166, 178, 104, 13, 240, 220,
    225, 14, 40, 31, 138,
  ]),
  secretKey: Uint8Array.from([
    56, 189, 248, 64, 27, 134, 132, 60, 134, 157, 195, 19, 58, 95, 51, 132, 55, 97, 137, 140, 73, 81, 38, 120, 237, 204, 113, 205,
    132, 69, 21, 18, 131, 218, 37, 152, 136, 89, 103, 247, 100, 150, 178, 36, 20, 126, 167, 1, 62, 222, 89, 85, 140, 166, 178,
    104, 13, 240, 220, 225, 14, 40, 31, 138,
  ]),
};

export const SLA_DEPLOYERS: Keypair[] = [Keypair.generate(), Keypair.generate(), Keypair.generate()];
export const SLA_KEYPAIRS: Keypair[] = [Keypair.generate(), Keypair.generate(), Keypair.generate()];
...
export const GOVERNANCE_PARAMETERS = {
  ...
  maxLeverage: { mantissa: new BN(1), scale: 0 },
};
export const SLOS = [
  {
    sloValue: {
